-- Remover tabelas se existirem para recriar corretamente
DROP TABLE IF EXISTS public.n8n_execution_logs;
DROP TABLE IF EXISTS public.n8n_configurations;

-- Criar tabela de configurações n8n
...
CREATE TABLE public.n8n_execution_logs (
  id UUID NOT NULL DEFAULT gen_random_uuid() PRIMARY KEY,
  config_id UUID NOT NULL REFERENCES public.n8n_configurations(id) ON DELETE CASCADE,
  workflow_id TEXT,
  execution_id TEXT,
